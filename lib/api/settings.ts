...
const MOCK_DEFINITIONS: SettingDefinition[] = [
  ...
  // Onboarding markers (Phase 3.1)
  {
    key: "onboarding.first_ai_tour_completed",
    label: "First-AI-conversation tour completed",
    description: "Set true once the user has dismissed the post-onboarding tour.",
  ...
  },
  {
    ...
    label: "Sample data seeded markers",
    description: "Map<module_key, ISO timestamp> recording when sample data was seeded per module.",
    category: "experimental",
    type: "json",
    schema: null,
    allowed_scopes: ["org"],
