...
| **P2** | No `INDEX.md` in most `apps/<module>/` directories | AI agents and new developers cannot navigate modules without reading all files | Only top-level DOCS/INDEX.md exists; per-module index absent | Create INDEX.md per module (template: `DOCS/templates/INDEX_TEMPLATE.md`); see `../06-governance/ai-maintainability.md §6` |
