...
/**
 * Defensive sanitizer for `match_excerpt`. The PlatformSearch contract
 * (spec §1) says backend escapes user content and emits ONLY `<mark>` tags.
 * We re-verify before injecting via dangerouslySetInnerHTML — strip any tag
 * other than `<mark>` / `</mark>`.
 */
